...
from .views import CreateBingoView, BingoJoinView, JoinTeamView, BingoBoardView, TeamDetailView, CreatorDetailView, MyBingoBoardView, EndTimeView, DeleteBingoView,UpdateProgressView
...
urlpatterns = [
    ...
    path('creator/detail/<int:bingo_id>/', CreatorDetailView.as_view(), name='creator_detail'),
