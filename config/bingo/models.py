...
class Bingo(models.Model):
    ...
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)  #유저와의 연결
...
class User_Team(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)  # User 테이블 참조
...
class BingoCell(models.Model):
    bingo_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
